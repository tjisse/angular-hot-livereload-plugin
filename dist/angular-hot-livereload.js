...
},{"./_root":19}],2:[function(require,module,exports){
/**
...
},{"./_Symbol":1,"./_getRawTag":15,"./_objectToString":18}],7:[function(require,module,exports){
/**
...
},{"./_Symbol":1,"./_arrayMap":2,"./isArray":26,"./isSymbol":28}],10:[function(require,module,exports){
...
},{"./_castSlice":10,"./_hasUnicode":16,"./_stringToArray":20,"./toString":30}],12:[function(require,module,exports){
...
},{"./_arrayReduce":3,"./deburr":25,"./words":32}],13:[function(require,module,exports){
...
},{"./_basePropertyOf":7}],14:[function(require,module,exports){
(function (global){
...
},{"./_asciiToArray":4,"./_hasUnicode":16,"./_unicodeToArray":21}],21:[function(require,module,exports){
/** Used to compose unicode character classes. */
var rsAstralRange = '\\ud800-\\udfff',
    rsComboMarksRange = '\\u0300-\\u036f',
    reComboHalfMarksRange = '\\ufe20-\\ufe2f',
...
},{"./_createCompounder":12,"./capitalize":24}],24:[function(require,module,exports){
...
},{"./toString":30,"./upperFirst":31}],25:[function(require,module,exports){
...
},{"./_deburrLetter":13,"./toString":30}],26:[function(require,module,exports){
/**
...
},{"./_baseGetTag":6,"./isObjectLike":27}],29:[function(require,module,exports){
...
},{"./_createCompounder":12}],30:[function(require,module,exports){
...
},{"./_baseToString":9}],31:[function(require,module,exports){
...
},{"./_createCaseFirst":11}],32:[function(require,module,exports){
...
},{"./_asciiWords":5,"./_hasUnicodeWord":17,"./_unicodeWords":22,"./toString":30}],33:[function(require,module,exports){
(function (global){
'use strict';
...
var _livereloadJs = (typeof window !== "undefined" ? window['LiveReload'] : typeof global !== "undefined" ? global['LiveReload'] : null);

var _livereloadJs2 = _interopRequireDefault(_livereloadJs);
...
var NgHotReloadPlugin = function () {
    function NgHotReloadPlugin(window, host) {
        _classCallCheck(this, NgHotReloadPlugin);
    ...
    _createClass(NgHotReloadPlugin, [{
        ...
        value: function reloadNgController(url) {
            var fullFileName = url.split('/').pop().substring(-1, url.lastIndexOf('.'));
        ...
        value: function reloadNgService(url) {
            var fullFileName = url.split('/').pop().substring(-1, url.lastIndexOf('.'));
            var fileName = fullFileName.substring(-1, fullFileName.indexOf('.'));
            var serviceName = NgHotReloadPlugin.capitalize((0, _camelCase2.default)(fileName));
        ...
        value: function reload(path) {
            path = path.replace(/\\/g, '/');
            if (path.match(/\.js$/i)) {
                var url = NgHotReloadPlugin.matchPathInScripts(path);
                if (!url) {
                    return false;
                }
            ...
            if (path.match(/\.html$/i)) {
                var _url = NgHotReloadPlugin.matchPathInTemplateCache(path);
                if (!_url) {
                    return false;
                }
                this.reloadNgTemplate(_url);
                return true;
            }
        }
        ...
        value: function matchPathInScripts(path) {
            ...
            while (splitPath.length > 0) {
                for (var i = 0; i < scriptElements.length; i++) {
                    var url = scriptElements[i].getAttribute('src');
                    if (url) {
        ...
        value: function matchPathInTemplateCache(path) {
            var doc = _angular2.default.element(window.document.body);
            var injector = doc.injector();
            if (injector) {
                var splitPath = path.split('/');
                while (splitPath.length > 0) {
                    var $templateCache = injector.get('$templateCache');
                    var url = splitPath.join('/');
                    var template = $templateCache.get(splitPath.join('/'));
                    if (template) {
                        return url;
                    }
                    splitPath = splitPath.slice(1);
    ...
    return NgHotReloadPlugin;
}();

NgHotReloadPlugin.identifier = 'ngHotReload';
NgHotReloadPlugin.version = '1.0';


module.exports = function () {
    if (_livereloadJs2.default && typeof _livereloadJs2.default.addPlugin == 'function') {
        _livereloadJs2.default.addPlugin(NgHotReloadPlugin);
    } else {
...
},{"lodash/camelCase":23,"lodash/kebabCase":29}]},{},[33]);
